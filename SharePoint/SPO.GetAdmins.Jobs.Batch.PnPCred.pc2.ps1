# SPO.GetAdmins.Jobs.Batch.PnPCred.pc2.ps1
# Sun May 1 2025 10:00:00
...
$Credential = Get-Credential -Message "Enter your SharePoint Online admin credentials" -UserName "bartco1\bartco1" -ErrorAction Stop
# $Credential = Get-Credential -Message "Enter your SharePoint Online admin credentials" -UserName "bartco1\bartco1" -ErrorAction Stop
...
foreach ($Batch in $SiteBatches) {
    $Jobs += Start-Job -ScriptBlock {
        param($Batch, $AdminCenterURL, [PSCredential]$credential)
